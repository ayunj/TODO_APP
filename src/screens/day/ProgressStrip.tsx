  ...
  return (
    <div className="mb-[11px] rounded-card bg-card px-[17px] pb-[17px] pt-4 shadow-card">
      <div className="mb-[11px] flex items-baseline justify-between gap-2.5">
        <span className="font-round text-[15px] text-accent">{saying(done, total)}</span>
        <span className="font-mono text-[13.5px] font-medium text-ink2">
          <b className="text-[16px] font-medium text-accent">{done}</b> / {total}
        </span>
      </div>
