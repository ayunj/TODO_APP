      ...
      <header className={shell}>
        <div className="flex items-center gap-1.5 pb-[14px] pt-[calc(14px+env(safe-area-inset-top))]">
          ...
          <div className="min-w-0 flex-1">
            <div className="text-[11.5px] font-medium tracking-[.1em] text-ink3">
              {view === 'shop'
                ? left > 0
                  ? `${left}개 담아둠`
                  : '살 것 적어두기'
            ...
            <h1 className="mt-px font-round text-[22px] font-normal leading-[1.2] tracking-[-.02em]">
              {view === 'shop' ? '장보기' : '메모'}
            </h1>
          </div>
        </div>
  ...
  return (
    <header className={shell}>
      ...
      <div className="flex items-center gap-2 pt-[calc(12px+env(safe-area-inset-top))]">
        <span className="min-w-0 flex-1 truncate text-[11.5px] font-medium tracking-[.1em] text-ink3">
          {eyebrow}
        </span>
        ...
        >
          ...
          {left > 0 && (
            <span className="absolute -right-0.5 -top-0.5 grid h-[18px] min-w-[18px] place-items-center rounded-full bg-accent px-1 font-mono text-[11px] font-medium text-white">
              {left}
            </span>
          )}
        </button>
      ...
      <div className="flex items-end gap-2 pb-3 pt-1.5">
        <h1 className="min-w-0 flex-1 font-round text-[23px] font-normal leading-[1.2] tracking-[-.02em]">
          {view === 'day' ? (
            <>
        ...
        <div className="flex flex-none items-center gap-px pb-0.5">
          <button
            ...
            aria-label="이전"
            onClick={() => step(-1)}
            className="grid h-[30px] w-[30px] place-items-center rounded-[10px] text-[17px] text-ink3 active:bg-sunk"
          >
            ‹
          </button>
          <button
