...
| [상점.html](상점.html) | **상점.** 홈의 띠로 들어간다 — 곰돌이가 위, 카드 격자가 아래. 걸쳐보고 산다 |
| [관리자.html](관리자.html) | **상점 채우기.** 그림 올리고 이름·종류(캐릭터·배경·소품 든 캐릭터)·갈래(꾸미기·시즌)를 고른다. **판이 둘 — 브라우저 1040px과 앱 360×800**, 그리고 넓은 판을 폰에 그대로 눌러 넣으면 어떻게 되는지도 나란히 |
